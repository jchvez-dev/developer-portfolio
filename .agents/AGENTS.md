...
* **UI Components:** Use `frontend/src/components/ui/` components (Button, Badge, Card, etc.) instead of raw HTML elements with Tailwind classes. Avoid inline Tailwind on semantic UI elements.
